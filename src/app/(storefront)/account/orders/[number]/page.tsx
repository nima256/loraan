...
export default function OrderDetailPage({ params }: { params: Promise<{ number: string }> }) {
  ...
  const [smsEnabled, setSmsEnabled] = useState(order?.smsNotifications ?? true);
          ...
          <div className="flex-1">
            <Switch
              ...
              onChange={(value) => {
                ...
                toast({
                  tone: "info",
                  title: value ? "پیامک وضعیت سفارش فعال شد" : "پیامک وضعیت سفارش غیرفعال شد",
                });
              }}
          ...
          <Card>
            ...
            <dl className="space-y-2.5 text-sm">
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <dd className="text-end text-fg">{PAYMENT_METHOD_LABELS[order.paymentMethod]}</dd>
              </div>
              {order.paymentRef && (
                <div className="flex items-start justify-between gap-3">
